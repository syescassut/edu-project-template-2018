...
describe('GET tests', function () {
    ...
    afterAll((done) => {
        ...
        fs.unlink(path, (err) => { if(err) console.log(err.message); });
...
describe('PUT tests', function () {
    beforeAll((done) => {
        dal.insert(
            {id: "1111-2222-3333-4444", name: "testName1", code: "S01E01", score: 7}
        );
        done();
    });
    it("Update episode test", (done) => {
        frisby.put(`${URL}/1111-2222-3333-4444`, {
                name: "testName2",
                code: "S02E02",
                score: 5
            })
    ...
    afterAll((done) => {
        var path = `${DATA_DIR}/1111-2222-3333-4444.json`;
        fs.unlink(path, (err) => { if(err) console.log(err.message); });
        done();
    });
});
